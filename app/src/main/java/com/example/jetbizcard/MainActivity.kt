    ...
    Surface(modifier = Modifier
        ...
        Card(modifier = Modifier
            ...
            Column(modifier = Modifier.height(300.dp), verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Divider(modifier = Modifier.padding(start = 5.dp, end = 5.dp),color = Color.Gray, thickness = 0.5.dp)
                CreateInfo()
                Button(onClick = {
        ...
        items(data){ item ->
            Card(modifier = Modifier
                ...
                Row(modifier = Modifier
                    ...
                    CreateImageProfile(90.dp)
                    Column(modifier = Modifier
                        .padding(7.dp)
                        .align(alignment = Alignment.CenterVertically)
                        ) {
                            Text(text = item, fontWeight = FontWeight.Bold)
                            Text(text = "$item is a great project", style = MaterialTheme.typography.body2)
                        }
...
@Composable
private fun CreateImageProfile(surfaceSize: Dp) {
    Surface(
        modifier = Modifier
            .size(surfaceSize)
            .padding(10.dp),
